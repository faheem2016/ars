         ...
         try
            {
                ...
                con.stmt.execute("INSERT INTO flight_schedule (departure_date, time, from_id, to_id) "
                        + "VALUES('"+date+"','"+ time +"','"+ from +"','"+ to +"')");
            ...
            catch(SQLException e)
            {
                ...
                request.setAttribute("error", "New schedule not successfully Added!");
                request.getRequestDispatcher("update_s.jsp").forward(request, response);
            }
