	...
	<body class="no-skin">
		...
		<div class="main-container" id="main-container">
			...
			<div class="page-content-area">
                            ...
                            <form class="form-horizontal" id="validation-form" action="update_city1" method="get">
                                
                                    
                                                    
                                    <div class="form-group">
                                            <label class="control-label col-xs-12 col-sm-3 no-padding-right" for="city">City name: </label>

                                            <div class="col-xs-12 col-sm-9">
                                                    <div class="clearfix">
                                                            <select class="col-xs-10 col-sm-5" id="form-field-1" name="city">
