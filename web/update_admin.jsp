                                    ...
                                    <div class="col-xs-9">
                                        ...
                                        <div class="row">
                                            <div class="col-xs-12">
                                                ...
                                                <!-- PAGE CONTENT BEGINS -->
                            <h3 class="lighter block green">Enter the following information to update Admin's Info</h3>
                                           
                            <form class="form-horizontal" id="validation-form" action="update_admin1" method="get">
