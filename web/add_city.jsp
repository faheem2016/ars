	...
	<body class="no-skin">
								...
								<li>
									...
									<a href="#">
                                                                            <form action="LogoutServlet" method="post">
                                                                                ...
                                                                                <input type="submit" value="Logout" style="background-color: #FEE188">
                                                                            </form>
		...
		<div class="main-container" id="main-container">
				...
				<ul class="nav nav-list">
					...
					<li class="">
						<a href="update_p.jsp">
							...
							<span class="menu-text"> Update Passenger</span>
						</a>
			...
			<div class="page-content-area">
                            ...
                            <form class="form-horizontal" id="validation-form" action="add_city" method="get">
                                           
                                    
                                    <div class="form-group">
                                            <label class="control-label col-xs-12 col-sm-3 no-padding-right" for="city">Enter City Name:</label>

                                            <div class="col-xs-12 col-sm-9">
                                                    <div class="clearfix">
                                                            <input type="text" id="city" name="city" class="col-xs-12 col-sm-5" />
                                                    </div>
                                            </div>
                                    </div>
				...
				<div class="footer-inner">
					...
					<div class="footer-content">
						<span class="bigger-120">
							<span class="blue bolder">FT</span>
							Airlines &copy; 2016
						</span>
